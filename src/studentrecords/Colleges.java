 ...
 * @author Joan
 */
public class Colleges extends javax.swing.JPanel {
    
    Connection con = null;
    PreparedStatement ps = null;
    ResultSet rs = null;
    
    CollegesView cv = new CollegesView();
    ...
    public Colleges() {
        ...
        cv.setVerifyInputWhenFocusTarget(false);
        
        cv.tblColleges.addMouseListener(new MouseAdapter()
        {
            public void mouseClicked(MouseEvent me) {
                lblStudents1.setText("|   View College Records");
            }
        });
    }
    ...
    public void populateTbl() {
        try {
            ...
            ps = con.prepareStatement("SELECT * FROM college ORDER BY college_code");
            rs = ps.executeQuery();
            cv.tblColleges.setModel(DbUtils.resultSetToTableModel(rs));
            rs.close();
            ps.close();
            con.close();
        } catch(Exception e) {
    ...
    public void clearFields() {
        cv.txtCollegeCode.setText("");
        cv.txtCollegeDesc.setText("");
        cv.dateChooser.toDay();
        cv.txtDateClosed.setText("");
        cv.cmbStatus.setSelectedIndex(0);
    }
    ...
    private void initComponents() {
        ...
        CollegesCard = new javax.swing.JLayeredPane();
        ...
        CollegesCard.setLayout(new java.awt.CardLayout());
        ...
        pnlChangingScreenLayout.setHorizontalGroup(
            ...
            .addGroup(javax.swing.GroupLayout.Alignment.TRAILING, pnlChangingScreenLayout.createSequentialGroup()
                ...
                .addGroup(pnlChangingScreenLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.TRAILING)
                    ...
                    .addComponent(CollegesCard, javax.swing.GroupLayout.Alignment.LEADING))
                .addGap(40, 40, 40))
        );
        pnlChangingScreenLayout.setVerticalGroup(
            ...
            .addGroup(pnlChangingScreenLayout.createSequentialGroup()
                ...
                .addGap(18, 18, 18)
                .addComponent(CollegesCard, javax.swing.GroupLayout.PREFERRED_SIZE, 615, javax.swing.GroupLayout.PREFERRED_SIZE)
    ...
    private void btnAddRecMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_btnAddRecMouseClicked
        ...
        if(btnAddRec.getText().equals("Add a New Record")) {
            lblStudents1.setText("|   Add New College Record");
            cv.btnAddRec.setText("Add Record");
            cv.txtCollegeCode.setEditable(true);
            cv.txtCollegeCode.setFocusable(true);
            cv.tblColleges.clearSelection();
            clearFields();
        }
    ...
    private void txtSearchKeyReleased(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_txtSearchKeyReleased
        ...
        try {
            con = ConnectDB.Connect();
            ps = con.prepareStatement("SELECT * FROM college WHERE college_code LIKE '%"+txtSearch.getText().toUpperCase()+"%'"
    ...
    private javax.swing.JLayeredPane CollegesCard;
