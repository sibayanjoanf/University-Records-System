...
public class Courses extends javax.swing.JPanel {
    ...
    public Courses() {
        ...
        csv.setVerifyInputWhenFocusTarget(false);
        
        csv.tblCourses.addMouseListener(new MouseAdapter()
        {
    ...
    public void populateTbl() {
        try {
            ...
            ps = con.prepareStatement("SELECT * FROM course WHERE  ORDER BY course_code");
            rs = ps.executeQuery();
            csv.tblCourses.setModel(DbUtils.resultSetToTableModel(rs));
            rs.close();
            ps.close();
            con.close();
        } catch(Exception e) {
    ...
    private void btnAddRecMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_btnAddRecMouseClicked
        ...
        if(btnAddRec.getText().equals("Add a New Record")) {
            lblStudents1.setText("|   Add New Course Record");
            csv.btnAddRec.setText("Add Record");
            csv.txtCourseCode.setEditable(true);
            csv.txtCourseCode.setFocusable(true);
            csv.tblCourses.clearSelection();
            clearFields();
        }
    ...
    private void txtSearchKeyReleased(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_txtSearchKeyReleased
        ...
        try {
            con = ConnectDB.Connect();
            ps = con.prepareStatement("SELECT * FROM course WHERE course_code LIKE '%"+txtSearch.getText().toUpperCase()+"%'"
