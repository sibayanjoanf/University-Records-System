 ...
 * @author Joan
 */
public class StudentsAdd extends javax.swing.JPanel {
    ...
    private void initComponents() {
        ...
        txtStudentNum.setSelectedTextColor(new java.awt.Color(0, 0, 0));
        txtStudentNum.setSelectionColor(new java.awt.Color(221, 197, 197));
        txtStudentNum.addFocusListener(new java.awt.event.FocusAdapter() {
            public void focusGained(java.awt.event.FocusEvent evt) {
                txtStudentNumFocusGained(evt);
            }
            public void focusLost(java.awt.event.FocusEvent evt) {
                txtStudentNumFocusLost(evt);
            }
        });
        txtStudentNum.addKeyListener(new java.awt.event.KeyAdapter() {
            public void keyPressed(java.awt.event.KeyEvent evt) {
                txtStudentNumKeyPressed(evt);
            }
            public void keyReleased(java.awt.event.KeyEvent evt) {
                txtStudentNumKeyReleased(evt);
            }
        });
        ...
        pnlStudentNumLayout.setHorizontalGroup(
            ...
            .addGroup(javax.swing.GroupLayout.Alignment.TRAILING, pnlStudentNumLayout.createSequentialGroup()
                ...
                .addComponent(txtStudentNum, javax.swing.GroupLayout.PREFERRED_SIZE, 109, javax.swing.GroupLayout.PREFERRED_SIZE)
                .addGap(14, 14, 14))
        );
        pnlStudentNumLayout.setVerticalGroup(
            pnlStudentNumLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
            .addComponent(txtStudentNum, javax.swing.GroupLayout.DEFAULT_SIZE, 36, Short.MAX_VALUE)
            .addComponent(lblStudentNumYear, javax.swing.GroupLayout.Alignment.TRAILING, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE)
        );
        ...
        jLabel10.setText("Do not leave an empty field as much as possible. Click the image on the right to add the student's photo.");
                ...
                .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    ...
                    .addGroup(jPanel1Layout.createSequentialGroup()
                        .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                            ...
                            .addComponent(cmbCourseCode, javax.swing.GroupLayout.PREFERRED_SIZE, 454, javax.swing.GroupLayout.PREFERRED_SIZE))
                        .addContainerGap())
                    .addGroup(jPanel1Layout.createSequentialGroup()
                        .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
        ...
        displayStudentLayout.setVerticalGroup(
            ...
            .addGroup(displayStudentLayout.createSequentialGroup()
                ...
                .addGroup(displayStudentLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING, false)
                    ...
                    .addComponent(imgStudent, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE))
                .addGap(31, 31, 31)
                .addGroup(displayStudentLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING, false)
    ...
    private void txtStudentNumFocusGained(java.awt.event.FocusEvent evt) {//GEN-FIRST:event_txtStudentNumFocusGained
        // TODO add your handling code here:
        pnlStudentNum.setBackground(new Color(240,240,240));
        txtStudentNum.setBackground(new Color(240,240,240));
    }//GEN-LAST:event_txtStudentNumFocusGained

    private void txtStudentNumFocusLost(java.awt.event.FocusEvent evt) {//GEN-FIRST:event_txtStudentNumFocusLost
        // TODO add your handling code here:
        pnlStudentNum.setBackground(new Color(248,248,248));
        txtStudentNum.setBackground(new Color(248,248,248));
    }//GEN-LAST:event_txtStudentNumFocusLost
    ...
    private void btnAddRecMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_btnAddRecMouseClicked
        ...
        try {
            ...
            con = ConnectDB.Connect();
            String query = "INSERT INTO student VALUES (?, ?, ?, ?, ?, (SELECT course_code FROM course WHERE description = ?), ?, ?, ?, ?, ?, ?, ?)";
            ...
            ps.setString(6, cmbCourseCode.getSelectedItem().toString());
            ps.setString(7, txtMobileNumber.getText().trim());
            ps.setString(8, capitalize(txtAddress1.getText().trim()));
            ps.setString(9, txtBday.getText().trim());
            ps.setString(10, statusAbbv());
            ps.setString(11, txtDateStarted.getText().trim());
            ps.setString(12, txtDateGrad.getText().trim());
            ps.setBlob(13, new ByteArrayInputStream(img));
            ps.execute();
            

            ps = con.prepareStatement("SELECT * FROM subject_schedule WHERE syear = '"+lblStudentNumYear.getText().toString() + "-" + (Integer.parseInt(lblStudentNumYear.getText().toString()) + 1)+"'");
            rs = ps.executeQuery();
            
            Set<String> insertedSubjectCodes = new HashSet<>();
            
            while (rs.next()){
                String subjectCode = rs.getString("subject_code");
                if (insertedSubjectCodes.contains(subjectCode)) {
                    continue;
                }
                
                ps = con.prepareStatement("INSERT INTO GRADES (syear, semester, student_no, subject_code, college_code, block_no, grade) VALUES (?, ?, ?, ?, ?, ?, ?)");
                ps.setString(1, rs.getString("syear"));
                ps.setString(2, rs.getString("semester"));
                ps.setString(3, lblStudentNumYear.getText().trim() + txtStudentNum.getText().trim());
                ps.setString(4, rs.getString("subject_code"));
                ps.setString(5, rs.getString("college_code"));
                ps.setString(6, "BLK 1");
                ps.setFloat(7, 3);
                ps.executeUpdate();
                
                insertedSubjectCodes.add(subjectCode);
            }
            ...
            clearFields();
            JOptionPane.showMessageDialog(null, "New student record has been added sucessfully!");
            ps.close();
            con.close();
        } catch(Exception e) {
            System.out.println(e);
...
//        try {
//            con = ConnectDB.Connect();
//            ps = con.prepareStatement("INSERT INTO grades(syear, student_no) VALUES('2023-2024', '"+lblStudentNumYear.getText().trim() + txtStudentNum.getText().trim()+"')");
//            ps.execute();
//            populateTbl();
//            ps.close();
//            con.close();
...
//        }
    ...
    private void txtStudentNumKeyReleased(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_txtStudentNumKeyReleased
        // TODO add your handling code here:
        txtStudentNum1.setText(lblStudentNumYear.getText() + txtStudentNum.getText());
    }//GEN-LAST:event_txtStudentNumKeyReleased
    ...
    private void txtStudentNumKeyPressed(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_txtStudentNumKeyPressed
        // TODO add your handling code here:
        limitInput(evt, txtStudentNum, 6);
    }//GEN-LAST:event_txtStudentNumKeyPressed
    ...
    private void txtGivenNameKeyPressed(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_txtGivenNameKeyPressed
        // TODO add your handling code here:
        limitStrInput(evt, txtGivenName, 30);
    ...
    private javax.swing.JLabel lblStudentNumYear;
    ...
    private javax.swing.JLabel txtDateGrad1;
