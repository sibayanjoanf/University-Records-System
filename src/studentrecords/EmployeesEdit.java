...
import static studentrecords.StudentsEdit.capitalize;

/**
 *
 * @author Joan
 */
public class EmployeesEdit extends javax.swing.JPanel {
    ...
    private void initComponents() {
        ...
        txtEmployeeID.setForeground(new java.awt.Color(153, 153, 153));
        txtEmployeeID.setBorder(null);
        txtEmployeeID.setSelectedTextColor(new java.awt.Color(153, 153, 153));
        txtEmployeeID.setSelectionColor(new java.awt.Color(248, 248, 248));
        ...
        pnlStudentNumLayout.setHorizontalGroup(
            ...
            .addGroup(pnlStudentNumLayout.createSequentialGroup()
                .addGap(14, 14, 14)
    ...
    private void btnEditRecMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_btnEditRecMouseClicked
        ...
        try {
            ...
            con = ConnectDB.Connect();  
            String query = "UPDATE employee SET lastname=?, firstname=?, email=?, gender=? "
                    + ", cp_num=?, address=?, birthday=?, status=?, date_started=?, date_resigned=?, employee_img=? "
                    + "WHERE employee_id = ?";
            ...
            ps.setString(5, txtMobileNumber.getText().trim());
            ps.setString(6, capitalize(txtAddress1.getText().trim()));
            ps.setString(7, txtBday.getText().trim());
            ps.setString(8, statusAbbv());
            ps.setString(9, txtDateStarted.getText().trim());
            ps.setString(10, txtDateResigned.getText().trim());
            ps.setBlob(11, new ByteArrayInputStream(img));
            ps.setString(12, txtEmployeeID.getText().trim());
            
//            con = ConnectDB.Connect();
//            ps = con.prepareStatement("UPDATE employee SET lastname = '"+capitalize(txtLastName.getText().trim())+"'"
//            + ", firstname = '"+capitalize(txtGivenName.getText().trim())+"'"
//            + ", email = '"+txtEmail.getText().trim()+"'"
//            + ", gender = '"+genderAbbv()+"'"
//            + ", cp_num = '"+txtMobileNumber.getText().trim()+"'"
//            + ", address = '"+capitalize(txtAddress1.getText().trim())+"'"
//            + ", birthday = '"+txtBday.getText().trim()+"'"
//            + ", status = '"+statusAbbv()+"'"
//            + ", date_started = '"+txtDateStarted.getText().trim()+"'"
//            + ", date_resigned = '"+txtDateResigned.getText().trim()+"'"
//            + "WHERE employee_id = '"+txtEmployeeID.getText().trim()+"'");
            ps.execute();
            populateTbl();
            JOptionPane.showMessageDialog(null, "Employee record has been updated sucessfully!");
            ps.close();
            con.close();
        } catch(Exception e) {
            System.out.println(e);
    ...
    public javax.swing.JLabel txtDateResigned1;
