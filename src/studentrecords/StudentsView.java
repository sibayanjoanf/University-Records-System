...
public class StudentsView extends javax.swing.JPanel {
    ...
    public StudentsView() {
        ...
        tblStudents.getTableHeader().setDefaultRenderer(new TableHeader());
        tblStudents.getTableHeader().setPreferredSize(new Dimension(0,40));
    ...
    public void populateTbl() {
        try {
            ...
            ps = con.prepareStatement("SELECT * FROM vw_student ORDER BY \"Last Name\"");
            rs = ps.executeQuery();
    ...
    public void gender() {
        ...
        switch(tblStudents.getModel().getValueAt(row, 4).toString()) {
    ...
    public void status() {
        int row = tblStudents.getSelectedRow();
        switch(tblStudents.getModel().getValueAt(row, 9).toString()) {
            case "A" -> txtStatus.setText("Active");
            case "I" -> txtStatus.setText("Inactive");
            default -> txtStatus.setText("Graduated");
        }
    }
    
    public String modifyDate(int column) {
        int row = tblStudents.getSelectedRow();
        Object value = tblStudents.getModel().getValueAt(row, column);
        if(value != null) {
    ...
    public void studentImgAppear() {        
        ...
        try {
            con = ConnectDB.Connect();
            String query = "SELECT student_img FROM student WHERE student_no = '"+tblStudents.getModel().getValueAt(row, 0).toString()+"'";
    ...
    private void initComponents() {
        ...
        txtDateGrad = new javax.swing.JLabel();
        ...
        tblStudents.setFont(new java.awt.Font("Arial", 0, 14)); // NOI18N
        ...
        tblStudents.setSelectionBackground(new java.awt.Color(239, 225, 225));
            ...
            .addGroup(displayStudentLayout.createSequentialGroup()
                ...
                .addGroup(displayStudentLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING, false)
                    .addGroup(displayStudentLayout.createSequentialGroup()
                        ...
                        .addComponent(txtStudentNum, javax.swing.GroupLayout.PREFERRED_SIZE, 225, javax.swing.GroupLayout.PREFERRED_SIZE)
                        .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
                            ...
                            .addGroup(displayStudentLayout.createSequentialGroup()
                                ...
                                .addGroup(displayStudentLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                                    .addGroup(displayStudentLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                                        ...
                                        .addComponent(txtDateGrad, javax.swing.GroupLayout.Alignment.TRAILING, javax.swing.GroupLayout.PREFERRED_SIZE, 198, javax.swing.GroupLayout.PREFERRED_SIZE))
                                    .addGroup(displayStudentLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING, false)
        ...
        displayStudentLayout.setVerticalGroup(
            ...
            .addGroup(displayStudentLayout.createSequentialGroup()
                .addGap(22, 22, 22)
                .addGroup(displayStudentLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING, false)
                    .addComponent(txtStudentNum, javax.swing.GroupLayout.DEFAULT_SIZE, 25, Short.MAX_VALUE)
                    .addComponent(jLabel15, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE)
                    .addComponent(pnlDeleteRec, javax.swing.GroupLayout.Alignment.TRAILING, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE))
                ...
                .addGroup(displayStudentLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.BASELINE)
                    ...
                    .addComponent(txtDateGrad, javax.swing.GroupLayout.PREFERRED_SIZE, 27, javax.swing.GroupLayout.PREFERRED_SIZE))
    ...
    private void tblStudentsMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_tblStudentsMouseClicked
        // TODO add your handling code here:
        int row = tblStudents.getSelectedRow();
        txtStudentNum.setText(tblStudents.getModel().getValueAt(row, 0).toString());
        txtLastName.setText(tblStudents.getModel().getValueAt(row, 1).toString());
        txtFirstName.setText(tblStudents.getModel().getValueAt(row, 2).toString());
        txtCourseCode.setText(tblStudents.getModel().getValueAt(row, 5).toString());
        txtEmail.setText(tblStudents.getModel().getValueAt(row, 3).toString());
        gender();
        txtMobileNum.setText("0" + tblStudents.getModel().getValueAt(row, 6).toString());
        txtAddress.setText(tblStudents.getModel().getValueAt(row, 7).toString());
        txtBday.setText(modifyDate(8));
        status();
        txtDateStarted.setText(modifyDate(10));
        txtDateGrad.setText(modifyDate(11));
        studentImgAppear();
    ...
    private void btnDeleteRecMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_btnDeleteRecMouseClicked
        ...
        if(response == JOptionPane.YES_OPTION) {
            ...
            if(txtStudentNum.getText().equals(""))
                ...
                try {
                    con = ConnectDB.Connect();
                    ps = con.prepareStatement("DELETE FROM grades WHERE student_no = '"+txtStudentNum.getText().trim()+"'");
                    ps.execute();
                    
                    ps = con.prepareStatement("DELETE FROM student WHERE student_no = '"+txtStudentNum.getText().trim()+"'");
                    ps.execute();
    ...
    public javax.swing.JLabel txtDateGrad;
